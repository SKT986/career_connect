...
export function CreateCompanyForm() {
  ...
  useEffect(() => {
    if (state.success) {
      toast.success("Invite sent — they'll set up their company profile once they sign in.");
      ...
      <CardContent className="p-5">
        <form ref={formRef} action={formAction} className="flex flex-wrap items-end gap-3">
          <div className="min-w-[200px] flex-1 space-y-1.5">
            <Label htmlFor="company-rep-email">Rep&apos;s email</Label>
            <Input id="company-rep-email" name="email" type="email" required placeholder="hiring@company.com" />
          </div>
          <div className="min-w-[160px] flex-1 space-y-1.5">
            <Label htmlFor="company-rep-name">Contact name</Label>
